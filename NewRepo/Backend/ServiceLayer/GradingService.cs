...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    {
        private KanBan_2024.ServiceLayer.ServiceFactory serviceFactory;
        public GradingService()
        {
            serviceFactory= new KanBan_2024.ServiceLayer.ServiceFactory();
        }
        ...
        {
            string res =  serviceFactory.US.Register(email, password);
        ...
        {
            string res = serviceFactory.US.Login(email, password);
            Response? r = JsonSerializer.Deserialize<Response>(res);
        ...
        {
            return serviceFactory.BS.LimitColumn(email, boardName, columnOrdinal, limit);
        }
        ...
        {
            string res = serviceFactory.BS.AddTask(email, boardName, title, description, dueDate);
            Response? r = JsonSerializer.Deserialize<Response>(res);
            r.ReturnValue = null;
        ...
        {
            string res = serviceFactory.TS.UpdateTaskDueDate(email, boardName, columnOrdinal, taskId, dueDate);
            Response? r = JsonSerializer.Deserialize<Response>(res);
            r.ReturnValue = null;
            return JsonSerializer.Serialize(r);
        }
        ...
        {
            string res = serviceFactory.TS.UpdateTaskTitle(email, boardName, columnOrdinal, taskId, title);
            Response? r = JsonSerializer.Deserialize<Response>(res);
            r.ReturnValue = null;
            return JsonSerializer.Serialize(r);
        }
        ...
        {
            string res = serviceFactory.TS.UpdateTaskDescription(email, boardName, columnOrdinal, taskId, description);
            Response? r = JsonSerializer.Deserialize<Response>(res);
            r.ReturnValue = null;
            return JsonSerializer.Serialize(r);
        }
        ...
        {
           return serviceFactory.BS.AdvanceTask(email, boardName, columnOrdinal, taskId);
        }
        ...
        {
            string res = serviceFactory.BS.CreateBoard(email, name);
            Response? r = JsonSerializer.Deserialize<Response>(res);
            r.ReturnValue = null;
            return JsonSerializer.Serialize(r);
        }
        ...
        {
            string res = serviceFactory.BS.DeleteBoard(email, name);
            Response? r = JsonSerializer.Deserialize<Response>(res);
            r.ReturnValue = null;
            return JsonSerializer.Serialize(r);
        }
        ...
        {
            return serviceFactory.TS.InProgressTasks(email);
        }
        ...
        {
            string res = serviceFactory.TS.AssignTask(email, boardName, columnOrdinal, taskID, emailAssignee);
            Response? r = JsonSerializer.Deserialize<Response>(res);
            r.ReturnValue = null;
            return JsonSerializer.Serialize(r);
        }
        ...
        {
            string res = serviceFactory.BS.TransferOwnership(currentOwnerEmail, newOwnerEmail, boardName);
            Response? r = JsonSerializer.Deserialize<Response>(res);
            r.ReturnValue = null;
            return JsonSerializer.Serialize(r);
        }
        ...
        {
            string r1 = serviceFactory.US.LoadData();
            string r2 = serviceFactory.BS.LoadData();

            Response? loadUS = JsonSerializer.Deserialize<Response>(r1);   
            Response? loadBS = JsonSerializer.Deserialize<Response>(r2);

            if(loadUS.ErrorMessage != null)
            {
                return r1;
            }
            if(loadBS.ErrorMessage != null)
            {
                return r2;
            }
        ...
        {
            string r1 = serviceFactory.US.DeleteData();
            string r2 = serviceFactory.BS.DeleteData();
